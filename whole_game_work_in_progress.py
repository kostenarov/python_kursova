...
def menu():
    global buy_factory, buy_cleaning, buy_windturbine, buy_land, counter, upgrade, clock, income, save_i, save_j, Button_Img
    ...
    def display_text():
        ...
        bar_color = (119, 136, 153)
        pygame.draw.rect(screen, color, pygame.Rect(610, 35, 170, 45))
        pygame.display.flip()
        score_display = font.render(f"MONEY : {money}", 1, (8, 255, 8))
        screen.blit(score_display, (450, 35))
        pygame.draw.rect(screen, bar_color, [80, 30, polution * 3, 30])

        pygame.display.update()

    for i in range(4):  # i e redove
        for j in range(4):  # j e koloni
            if i == 1:
                b[i][j] = button(screen, ((90 * (j + 1)), 100), "      ")  # first one x,second one y
            elif i == 2:
    ...
    while running == 0:
        ...
        money += income
        if counter_cleaning_station > 0 or counter_cleaning_station_upgrade > 0 and polution > 0:
        ...
        elif counter_cleaning_station == 0 and counter_cleaning_station_upgrade == 0:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                if buy_factory.collidepoint(mx, my) and money >= factory.cost and bought[save_i][save_j] == 10 and bought[save_i][save_j] != 11 and bought[save_i][save_j] != 12 and bought[save_i][save_j] != 13 and bought[save_i][save_j] != 21 and bought[save_i][save_j] != 22 and bought[save_i][save_j] != 23:
                    ...
                    Button_Img = pygame.image.load("buildings/factory.png")
                    if save_j <= 3:
                        screen.blit(Button_Img, (90 * (save_j + 1), 100 * save_i))
                    elif save_i == 3:
                        screen.blit(Button_Img, (90 * (save_j + 1), 100 * save_i))
                if buy_cleaning.collidepoint(mx, my) and money >= cleaning_station.cost and bought[save_i][save_j] == 10 and bought[save_i][save_j] != 11 and bought[save_i][save_j] != 12 and bought[save_i][save_j] != 13 and bought[save_i][save_j] != 21 and bought[save_i][save_j] != 22 and bought[save_i][save_j] != 23:
                    ...
                    Button_Img = pygame.image.load("buildings/cleaning.png")
                    if save_j <= 2:
                        screen.blit(Button_Img, (90 * (save_j + 1), 100 * save_i))
                    elif save_i == 3:
                        screen.blit(Button_Img, (90 * (save_j + 1), 400))
                if buy_windturbine.collidepoint(mx, my) and money >= windturbine.cost and bought[save_i][save_j] == 10 and bought[save_i][save_j] != 11 and bought[save_i][save_j] != 12 and bought[save_i][save_j] != 13 and bought[save_i][save_j] != 21 and bought[save_i][save_j] != 22 and bought[save_i][save_j] != 23:
                    ...
                    Button_Img = pygame.image.load("buildings/windturbine.jpeg")
                    if save_j <= 2:
                        screen.blit(Button_Img, (90 * (save_j + 1), 100 * save_i))
                    elif save_j == 3:
                        screen.blit(Button_Img, (90 * (save_j + 1), 400))
                if upgrade.collidepoint(mx, my) and money >= 10000 and bought[save_i][save_j] == 11:
                    ...
                    Button_Img = pygame.image.load("buildings/factory_upgrade.png")
                    if save_j <= 2:
                        screen.blit(Button_Img, (90 * (save_j + 1), 100 * save_i))
                    elif save_j == 3:
                        screen.blit(Button_Img, (90 * (save_j + 1), 400))
                ...
                if upgrade.collidepoint(mx, my) and money >= 10000 and bought[save_i][save_j] == 13:
                    ...
                    Button_Img = pygame.image.load("buildings/windturbine_upgrade.jpg")
                    if save_j <= 2:
                        screen.blit(Button_Img, (90 * (save_j + 1), 100 * save_i))
                    elif save_i == 3:
                        screen.blit(Button_Img, (90 * (save_j + 1), 400))
